...
export default function EditProductModal({ isOpen, onClose, onSuccess, product }) {
    ...
    useEffect(() => {
        if (product) {
            setFormData({
                ...
                nutritionalInformation: product.nutritionalInformation && product.nutritionalInformation.length > 0
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await apiClient.patch(`/api/menu-items/update/${product.id}`, submitData);
